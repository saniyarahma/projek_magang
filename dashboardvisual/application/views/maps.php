 ...
 <div class="preloader flex-column justify-content-center align-items-center">
  ...
  <div class="content-wrapper">
    ...
    <div class="row">
      ...
      <div class="col-sm-4">
        <form method="post" action="<?php echo base_url('Home/input_lokasi') ?>">
...
<script>
  var map = L.map('map').setView([-6.989025859864826, 110.42203282559893], 19);
  ...
  var curLocation = [-6.989025859864826, 110.42203282559893];
